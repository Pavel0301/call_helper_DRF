...
class OrganisationFilter(django_filters.FilterSet):
    can_manage = django_filters.BooleanFilter(field_name='can_manage', label='Can manage')
...
class EmployeeFilter(django_filters.FilterSet):
    only_corporate = django_filters.BooleanFilter(field_name='user__is_corporate_account', label='Is corporate account')
...
class GroupFilter(django_filters.FilterSet):
    is_member = django_filters.BooleanFilter(field_name='is_member')
